    ...
    <section className="relative py-24 bg-white">
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row gap-20 items-stretch">
          ...
          <div className="w-full max-w-[520px] lg:max-w-[540px] h-[540px] lg:h-[580px] mx-auto lg:ml-16 relative shadow-sm mt-8 lg:mt-[-32px] flex flex-col justify-center items-center bg-primary/10 rounded-2xl p-6 lg:p-14 self-end">
            {/* Labels */}
